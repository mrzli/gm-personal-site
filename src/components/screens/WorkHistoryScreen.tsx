      ...
      <SimpleText>
        ...
        <ul>
          ...
          <li>
            ...
            started (there was some quite sporadic development before, by a
            single person I believe, and the project was in some kind of a
            prototype phase). The two of us did most of the work in the
            beginning, and we were able to make some architectural choices at
            this time, but the team quickly grew over the next few months to (I
            think) more than 10 people on the frontend alone. After this, my
            role was essentially that of a senior developer. I was responsible
            for some application-wide changes, some subsystems/patterns that
            were reused throughout the project, and also some larger features
            and screens, down to simpler maintenance work when required.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            ...
            Boot, Kotlin, Liquibase, PostgreSQL, H2, Jasper Reports, Docker,
            Docker Swarm.
          </li>
          <li>
            ...
            of the functionality - works great for my case. There are not
            ...
            tasks and try out deployment process, but in the end the production
        ...
        <p>
          ...
          hundred possible rules of dozens of distinct types. The validation
          rules needed to be configurable, and this is done using a json files
          several thousand lines long, to account for all of the needed checks.
          The component is used as a part of at least two larger systems.
          Conceptually, the component works simply by accepting a structured
          list of invoice data, and outputs a structured list of validation
          errors and warnings (if any) with all the relevant data for each
          issue:
        </p>
        <ul>
