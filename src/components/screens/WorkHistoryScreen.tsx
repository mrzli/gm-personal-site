...
export function WorkHistoryScreen(
  ...
  return (
    <div>
      ...
      <p>TODO: insurercore</p>
      <ul>
        <li>Techs used: TODO</li>
        <li>My role: TODO</li>
      </ul>
      <p>TODO: banking software Analyste</p>
      <ul>
        <li>Techs used: TODO</li>
        <li>My role: TODO</li>
      </ul>
      ...
      <ul>
        <li>
          Techs used: Vue, Typescript, Jest, OpenLayers (JavaScript), Spring
          Boot, Kotlin, Liquibase, PostgreSQL, Jasper Reports, Docker, Docker
          Swarm.
        </li>
        <li>
          My role: I implemented almost the entire app, and refactored the small
          parts that I did not initially implement. TODO complete
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li>Tech used: Java, REST</li>
        <li>
          My role: I implemented the "middle" part of the app - the part that
          connects all the other parts of the app, and is also the top layer of
          the backend. This part includes the web API (REST), to be used by the
          mobile frontends (Android and iOS), backend validations, and it
      ...
      <p>
        ...
        Office). NIAS is a Single Sign-on system. This interface allows existing
        users of NIAS to log in to the client's system, and allows the client to
        provide credentials for its users to access dozens of other services
        that are part of the NIAS system (so it works two ways):
      </p>
      <ul>
      ...
      <p>
        ...
        hundred possible rules of dozens of distinct types. The validation rules
        needed to be configurable, and this is done using a json files several
        thousand lines long, to account for all of the needed checks. The
        component is used as a part of at least two larger systems.
        Conceptually, the component works simply by accepting a structured list
        of invoice data, and outputs a structured list of validation errors and
        warnings (if any) with all the relevant data for each issue:
      </p>
      <ul>
        ...
        <li>
          ...
          validation logic quite complicated, this is probably the best example
          of an application where automated tests are so easily devised and so
          invaluable. The first batch of detailed manual tests done by QA
          revealed a few errors (in a very large number of test scenarios). I
          was given a very well structured Excel file with results, which I was
          easily able to convert to a CSV usable for testing. So all of those
          tested scenarios (the ones that already passed, and the ones that
          failed) became part of the testing suite. All I needed to do was make
          the changes so that all of the tests pass, which was very easy at this
          point. There were no further errors that I know of.
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          application used for administration of this tracking system, from the
          REST API down to the repository/data access layer. This includes JPA
          and QueryDSL queries as well as some parts of the database, mostly
          related to the admin application itself (such as account management
      ...
      <ul>
        ...
        <li>
          My role: Besides some initial work by other developers, I implemented
          the entire application. I also handled deployment, communication with
          clients and I was actively involved in the development of
          requirements.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          other forms, ranging from bug fixes to implementing significant parts
          of those forms. The entire application at the time had about 25 tax
          forms. Implementing a tax form includes doing a web form, xml
          import/export, PDF reporting, extensive server-side validation based
          on business and legal rules, and tax form specific changes to the data
          access layer.
        </li>
      </ul>
      <p>
        Web application used for submission of data related to various types of
        location and building permits, built for Croatia’s Ministry of
      ...
      <ul>
        <li>
          I worked on frontend/backend development and maintenance of two large
          ASP.NET Web Forms applications used by the employees of Croatia’s
        ...
        <li>
          ...
          applications for communication with other systems, for service calls,
          authentication etc.
        </li>
        <li>
      ...
      <SimpleText>
        ...
        <ul>
          ...
          <li>
            ...
            versioning system, signal filtering and mixing, and in general many
            of the WPF views and view models and the underlying code down to the
            persistence layer.
          </li>
        </ul>
        <p>
